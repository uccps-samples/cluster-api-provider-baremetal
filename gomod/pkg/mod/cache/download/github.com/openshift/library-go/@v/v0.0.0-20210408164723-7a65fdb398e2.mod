...
require (
	...
	github.com/uccps-samples/api v0.0.0-20210331193751-3acddb19d360
	github.com/uccps-samples/build-machinery-go v0.0.0-20210209125900-0da259a2c359
	github.com/uccps-samples/client-go v0.0.0-20210331195552-cf6c2669e01f
